...
from pytrebuchet.differential_equations.whipper_both_constrained_phase import whipper_both_constrained_ode, whipper_weight_separation_event
from pytrebuchet.differential_equations.whipper_projectile_constrained_phase import whipper_projectile_constrained_ode, whipper_projectile_separation_event
