...
class Projectile:
    """Represent a projectile launched by the trebuchet.
    ...
    def default(cls) -> "Projectile":
        """Create a projectile with default parameters.

        Default parameters as used by https://virtualtrebuchet.com (pumpkin).

        :return: Projectile instance with default parameters
        """
